...
<head>
    ...
    <meta name="description" content="Backoffice utilisateurs Info Iran : gérez les comptes, rôles et droits d'accès de l'équipe éditoriale.">
...
<?php renderBackofficeNavbar('utilisateurs', $username); ?>
