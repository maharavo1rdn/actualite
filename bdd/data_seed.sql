...
('Geopolitique', 'Nouvelles et analyses geopolitiques'),
('Humanitaire', 'Suivi des populations civiles et de l aide internationale'),
('Economie', 'Informations economiques et financieres'),
('Climat', 'Evenements climatiques et environnementaux');
...
-- Mots de passe en clair pour reference :
-- admin  -> adminpass
...
('Media', 'Source de presse ou agence de presse'),
...
('<h1>Le prix du baril franchit un nouveau seuil</h1>', 'prix-baril-franchit-nouveau-seuil', '<p>La volatilite des marches energetiques se maintient a un niveau eleve.</p><p>Les importateurs asiatiques constituent des stocks tampons pour limiter les ruptures.</p><p>Les banques centrales surveillent les effets inflationnistes secondaires.</p>', '2026-03-27 18:20:00', 3),
...
(3, '/assets/images/photo-1504711434969-e33886168f5c.jpeg', 'Convoi commercial escorte dans un couloir maritime'),
...
('<h4>Suivi des stocks energetiques</h4>', '2026-03-26 08:30:00', '<p>Les reserves strategiques sont mobilisees dans plusieurs pays importateurs.</p>', 4),
